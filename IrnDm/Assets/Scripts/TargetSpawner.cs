...
public class TargetSpawner : MonoBehaviour {
    ...
    IEnumerator MakeObject()
    {
        ...
        GameObject targetInstance = Instantiate(Target, SpawnDirection * SpawnDistance + new Vector3(0, 4, 0),
            new Quaternion(SpawnDirection.z, 0, -SpawnDirection.x, Mathf.Cos(FacingAngle)));
        targetInstance.GetComponent<Rigidbody>().AddForce(targetInstance.transform.up * -LaunchPower,
            ForceMode.Impulse);
